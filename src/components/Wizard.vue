...
export default {
  ...
  methods: {
    ...
    submitStep1() {
      console.log("This is the submitStep1 of wizard.vue");
    //   this.$eventBus.$emit("submitGeneralDetails");
        // this.$refs.gdForm.submitGeneralDetails();
    },
  },
  mounted() {
    this.isMobile = this.$refs["wizard-body"].clientWidth < 620;
    window.addEventListener("resize", this.handleResize);
    // console.log("mounted inside wizard.vue");
    // this.$eventBus.$on("submitStep1", this.submitStep1);
  },
  beforeDestroy() {
